...
const PostCreator = ({ backFromCreator }) => {
  ...
  const addItemToList = () => {
    ...
    setItems([
      ...
      {
        name: itemName,
        price: itemPrice && parseInt(itemPrice),
        img: itemImage,
      },
    ]);
    setItemName("");
  ...
  const handleResultSelect = (e, { result }) => {
    ...
    if (!result.image && !result.price) {
      ...
      setItems([
        ...
        {
          name: result.title,
          price: result.price && parseInt(result.price),
          img: result.image,
        },
      ]);
    }
      ...
      <div className="market-items--creator">
        ...
        {items.map(({ name, price, img }) => (
          <div className="market-items--input">
            <div className="market-items--creator--item">
              <span>
                {img ? (
                  <img src={img} className="market-items--bell-image" />
                ) : (
                  <LeafIcon />
                )}
              </span>
        ...
        {isCustom && (
          <div className="market-items--input-with-error">
            <div className="market-items--input">
              <Label icon="tag" iconPosition="left" placeholder="Nom item">
                <Icon name="tag"></Icon>
                {itemName}
              </Label>
